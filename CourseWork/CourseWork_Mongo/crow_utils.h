...
inline const RequestCorrectnessInfo
GetRequestInfo(const crow::request& request)
{
...
inline std::string
GetUserId(crow::App<crow::CookieParser>& app, const crow::request& request)
{
...
inline void
LoadFriendsToJson(const std::vector<std::string>& friends,
...
inline void
LoadMessagesToJson(const std::vector<Message>& messages,
	crow::json::wvalue& json)
{
	int messagesCount = 0;
...
inline void
LoadSearchResultsToJson(const std::string& username,
